...
public:
    ...
    void StartSessionStreamCtl(const basefw::ID& sessionId,CubicCongestionCtlConfig& ccConfig,std::weak_ptr<SessionStreamCtlHandler> ssStreamHandler)
    {
        if (isRunning)
        {
        ...
        // cc
        m_ccConfig = ccConfig;
        m_congestionCtl.reset(new CubicCongestionControl(m_ccConfig));
...
private:
    ...
    CubicCongestionCtlConfig m_ccConfig;
